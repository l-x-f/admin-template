<template>
  <el-dialog title="审核" :visible.sync="dialogVisible" width="40%" center>
    ...
    <el-input v-model="reason" class="margin-top-10" type="textarea" :rows="2" />
    <span slot="footer" class="dialog-footer">
      <el-button size="small" @click="dialogVisible = false">
        <i class="fa fa-history" /> 取消
      </el-button>

      <el-button :loading="rejectLoading" size="small" @click="handleRejectAudit">
        <i class="fa fa-times-circle" /> 驳回
      </el-button>
      <el-button type="primary" :loading="passLoading" size="small" @click="handlePassAudit">
        <i class="fa fa-check-circle-o" /> 通过
      </el-button>
    </span>
  </el-dialog>
</template>
